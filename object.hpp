...
public:
	...
	// Coefficient de refraction [1 -> aucune refraction(vacuum)]
	// You have to be transparent for refraction to work!
	double refract;

	// If object is tranparent or not (is a float but acts as a bool) 0-> not transparent 1->is transparent
	double transparent;
};
